...
@section('admin-content')
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Tambah Organisasi</h5>
            <form action="{{ route('admin.organisasi.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <input type="email" name="contact_email" id="contact_email"
                                ...
                                placeholder="Masukkan email kontak" value="{{ old('contact_email') }}">
                            @error('contact_email')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-lg-3">
                        <div class="mb-3">
                            ...
                            <input type="text" name="qris_name" id="qris_name"
                                ...
                                placeholder="Masukkan nama QRIS" value="{{ old('qris_name') }}">
                            @error('qris_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-lg-3">
                        <div class="mb-3">
                            ...
                            <input type="text" name="qris_info" id="qris_info"
                                ...
                                placeholder="Masukkan nama QRIS" value="{{ old('qris_info') }}">
                            @error('qris_info')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="row text-dark">
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <textarea name="visi" id="visi" class="form-control @error('visi') is-invalid @enderror"
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <textarea name="misi" id="misi" class="form-control @error('misi') is-invalid @enderror"
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <label for="core_values" class="form-label">Core Values <span
                                    class="text-danger">*</span></label>
                            <textarea name="core_values" id="core_values" class="form-control @error('core_values') is-invalid @enderror"
                                placeholder="Masukkan core values">{{ old('core_values') }}</textarea>
                            @error('core_values')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <label for="focus_areas" class="form-label">Focus Areas <span
                                    class="text-danger">*</span></label>
                            <textarea name="focus_areas" id="focus_areas" class="form-control @error('focus_areas') is-invalid @enderror"
                                placeholder="Masukkan focus areas">{{ old('focus_areas') }}</textarea>
                            @error('focus_areas')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="about" id="about" class="form-control @error('about') is-invalid @enderror"
                        placeholder="Masukkan deskripsi organisasi">{{ old('about') }}</textarea>
                    @error('about')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <img class="qris-preview img-fluid mt-2 col-sm-4" style="display:none;">
                    @error('qris_image')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
...
@push('custom-script')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const editors = ['about', 'visi', 'misi', 'core_values',
                'focus_areas'
            ];
            editors.forEach(id => {
