...
@section('admin-content')
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Edit Publikasi</h5>
            <form action="{{ route('admin.publikasi.update', $publikasis->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" id="title"
                                ...
                                placeholder="Masukkan nama publikasi" value="{{ old('title', $publikasis->title) }}">
                            @error('title')
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <select name="status_publikasi" id="status_publikasi"
                                ...
                                <option value="Hidden"
                                    {{ old('status_publikasi', $publikasis->status_publikasi) == 'Hidden' ? 'selected' : '' }}>
                                    Hidden</option>
                                <option value="Published"
                                    {{ old('status_publikasi', $publikasis->status_publikasi) == 'Published' ? 'selected' : '' }}>
                                    Published</option>
                            </select>
                    ...
                    <div class="col-lg-12">
                        <div class="mb-3">
                            ...
                            <input type="text" name="author" id="author"
                                ...
                                placeholder="Masukkan penulis publikasi" value="{{ old('author', $publikasis->author) }}">
                            @error('author')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="editor" name="description" class="form-control @error('description') is-invalid @enderror"
                                placeholder="Masukkan isi deskripsi publikasi">{{ old('description', $publikasis->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <div class="modal-footer mt-3">
                    <a href="{{ route('admin.publikasi.index') }}" class="btn btn-dark rounded-3 me-3">Kembali</a>
