...
@section('admin-content')
    <div class="card">
        <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Edit Volunteer</h5>
            <form action="{{ route('admin.volunteer.update', $volunteer->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row text-dark">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <input type="text" name="title" id="title"
                            ...
                            placeholder="Masukkan nama volunteer" value="{{ old('title', $volunteer->title) }}">
                        @error('title')
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <select name="status_publikasi" id="status_publikasi"
                            ...
                            <option value="Hidden"
                                {{ old('status_publikasi', $volunteer->status_publikasi) == 'Hidden' ? 'selected' : '' }}>
                                Hidden</option>
                            <option value="Published"
                                {{ old('status_publikasi', $volunteer->status_publikasi) == 'Published' ? 'selected' : '' }}>
                                Published</option>
                        </select>
                ...
                <div class="mb-3">
                    ...
                    <div id="positions-container">
                        @forelse(old('positions', $volunteer->positions) as $position)
                ...
                <div class="mb-3">
                    ...
                    <textarea id="description_editor" name="description" class="form-control @error('description') is-invalid @enderror"
                        placeholder="Masukkan deskripsi volunteer">{{ old('description', $volunteer->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
