...
@section('title', $publikasis->title . ' - Watery Nation')
        ...
        <div class="row justify-content-between">
            <div class="col-lg-8 mb-5">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <a href="{{ route('publikasi') }}" class="btn btn-primary rounded-pill px-4">
                ...
                <!-- Gambar Utama -->
                <div class="mb-4">
                    <img src="{{ Storage::url($publikasis->image) }}" alt="{{ $publikasis->title }}"
                        class="img-fluid rounded-4 shadow-sm w-100" style="width: 100%; height: 500px; object-fit:fill;">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="text-muted mb-3" style="font-size:0.9rem;">
                        ...
                        {{ tanggal($publikasis->date) }} |
                        <i class="bi bi-person-fill"></i> {{ $publikasis->author }}
                    </div>
                </div>

                <!-- Isi Publikasi -->
                <div class="text-muted" style="font-size:0.95rem; line-height:1.7;">
                    {!! $publikasis->description !!}
                </div>
            </div>
            <div class="col-lg-4">
