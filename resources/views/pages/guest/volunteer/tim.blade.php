            ...
            @forelse ($volunteers as $volunteer)
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                    <div class="card h-100 shadow-sm rounded-3 p-3">
                        <!-- Foto Bulat -->
                        <div class="mx-auto rounded-circle overflow-hidden shadow-lg mt-3"
                            style="width:150px; height:150px;">
                            <img src="{{ Storage::url($volunteer->image) }}" class="w-100 h-100" style="object-fit:cover;"
                                alt="{{ $volunteer->name ?? '-' }}">
                        </div>
                        ...
                        <div class="card-body pt-3">
                            ...
                            <div class="d-flex flex-column justify-content-center align-items-center mb-3 text-muted"
